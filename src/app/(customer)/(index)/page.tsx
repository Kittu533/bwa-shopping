...
import ListCategories from "./_componets/List-Categories";
import ListProductPick from "./_componets/List-Product-Pick";
import ListBrands from "./_componets/List-Brands";
import ListProductNew from "./_componets/List-Product-New";
    ...
    <>
      ...
      >
        ...
        <Suspense fallback={<span>Loading...</span>}>
          <ListCategories title={<><span>Browse Products</span> <br /> by Categories</>} />
        </Suspense>
        {/* List Most Product Pick */}
        <Suspense fallback={<span>Loading...</span>}>
          <ListProductPick title={<><span>Most Picked</span> <br /> Quality Products</>} />
        </Suspense>
        {/* List Brand */}
        <Suspense fallback={<span>Loading...</span>}>
          <ListBrands title={<><span>Explore Our</span> <br /> Popular Brands</>} />
        </Suspense>
        {/* ListProductNew */}
        <Suspense fallback={<span>Loading...</span>}>
          <ListProductNew title={<><span>New Arrivals</span> <br /> Latest Products</>} />
        </Suspense>
      </section>
    </>
  );
